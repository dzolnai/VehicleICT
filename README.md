#VehicleICT
==========
VehicleICT is an experiment to create a next-generation service for smart-cars, backed by large scale data processing capabilities based on Hadoop. For development purposes, the project highly relies on Google Cloud services, such as Compute Engine, App Engine, Cloud Storage, etc.
##Notes

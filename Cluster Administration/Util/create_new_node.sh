#! /bin/bash
#Creates a new node with name arg[0] size arg[1] type arg[2]

gcutil adddisk $1-node-disk --source_image=debian-7 --size_gb=$2 --zone=europe-west1-b
sleep 10
gcutil addinstance $1-node --disk=$1-node-disk,boot --machine_type=n1-standard-$3 --zone=europe-west1-b
sleep 40
